...
// outro lado: a mecânica do TRIO (chamada promete → legenda paga → CTA fecha
// o laço), as regras obrigatórias e as famílias de gancho.
//
...
//
// NADA aqui toca a direção de arte. historia_visual, descricao_fundo,
// resumo_cena e as diretrizes A a E continuam no App.jsx, intactas.
//
...
export const FAMILIAS = [
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA '3 SINAIS DE QUE SEU FREIO ESTÁ NO LIMITE' / LEGENDA '1) Chia ao frear devagar. 2) O pedal desce mais que o normal. 3) O carro puxa para um lado. Qualquer um dos três já é hora de olhar - não espere os três.' / CTA 'Traz o seu que a gente olha na hora'",
      [PUBLICOS.ADVOCACIA]:
        "CHAMADA '3 DOCUMENTOS QUE VOCÊ PRECISA GUARDAR' / LEGENDA '1) Contrato de trabalho assinado. 2) Comprovantes de pagamento. 3) Registros de jornada. Em uma discussão trabalhista, a ausência desses documentos costuma dificultar a comprovação dos fatos.' / CTA 'O quarto está no perfil'",
      [PUBLICOS.SAUDE]:
        "CHAMADA '3 SINAIS DE QUE O SONO NÃO ESTÁ RESTAURADOR' / LEGENDA '1) Acordar cansado mesmo depois de 8 horas. 2) Sonolência no meio da tarde. 3) Dor de cabeça ao levantar. Nenhum dos três é normal por si só e todos merecem investigação.' / CTA 'Traga esses sinais na avaliação'",
    },
  ...
  },
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA 'PARE DE LAVAR O CABELO COM ÁGUA QUENTE' / LEGENDA 'A água quente abre a cutícula e leva embora a cor e a oleosidade natural. Resultado: cabelo opaco em duas semanas. Lave com água morna e finalize com fria.' / CTA 'Te digo o certo pro seu cabelo. Chama'",
      [PUBLICOS.SAUDE]:
        "CHAMADA 'SALADA NO ALMOÇO NÃO SUBSTITUI A REFEIÇÃO' / LEGENDA 'Trocar o almoço por salada costuma deixar a refeição sem proteína e sem energia suficiente, e a fome volta no meio da tarde. A salada entra junto do prato, não no lugar dele.' / CTA 'A gente monta isso na avaliação'",
    },
  ...
  },
  {
    ...
    exemplos: {
      ...
      [PUBLICOS.SAUDE]:
        "CHAMADA 'O QUE ACONTECE ANTES DA SUA CONSULTA' / LEGENDA 'Todo retorno começa com a releitura da ficha e dos exames trazidos na consulta anterior. São uns 15 minutos antes de a porta abrir, e é o que permite retomar exatamente de onde paramos.' / CTA 'Seu retorno começa assim. Agende'",
    },
  ...
  },
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA 'DEIXA HOJE. BUSCA AMANHÃ.' / LEGENDA 'Lavagem, secagem e dobra em 24 horas. Você deixa a sacola na entrada e recebe tudo separado por tipo de peça. Sem fila, sem ficha.' / CTA 'Chama que a gente reserva a de amanhã'",
    },
  ...
  },
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA 'VOU TER QUE PARAR DE COMER PÃO?' / LEGENDA 'Não. Essa é a pergunta que mais chega aqui e a resposta é não. O que muda é a quantidade, o horário e o que vai junto. Plano que proíbe tudo é plano que ninguém segue.' / CTA 'E o seu caso? Manda a dúvida aqui'",
      [PUBLICOS.SAUDE]:
        "CHAMADA 'VOU TER QUE PARAR DE COMER PÃO?' / LEGENDA 'Não. Essa é a pergunta que mais chega ao consultório e a resposta é não. O que costuma mudar é a quantidade, o horário e o que vai junto. Cada caso é avaliado individualmente.' / CTA 'O seu caso a gente vê na avaliação'",
      [PUBLICOS.ADVOCACIA]:
        "CHAMADA 'PRECISO DE ADVOGADO PRA ISSO?' / LEGENDA 'Nem todo problema vira processo. Parte se resolve em acordo ou com um documento bem redigido. O trabalho começa antes disso: entender o caso e apontar quais são os caminhos possíveis.' / CTA 'Os caminhos possíveis estão no perfil'",
    },
  ...
  },
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA 'PRA QUEM SOFRE NA HORA DO BANHO' / LEGENDA 'Cachorro que treme, foge e faz drama. A gente atende com hora marcada, um por vez, sem outros cães no salão. Menos barulho, menos medo.' / CTA 'Marca no horário mais vazio do dia'",
      [PUBLICOS.SAUDE]:
        "CHAMADA 'PRA QUEM TRABALHA SENTADO O DIA INTEIRO' / LEGENDA 'Oito horas na mesma posição sobrecarregam pescoço e lombar, e o incômodo costuma aparecer só no fim do dia. Pausas curtas com movimento a cada hora mudam mais a rotina do que qualquer acessório.' / CTA 'As pausas certas a gente vê na consulta'",
      [PUBLICOS.ADVOCACIA]:
        "CHAMADA 'PRA QUEM VAI COMPRAR O PRIMEIRO IMÓVEL' / LEGENDA 'Antes da assinatura costumam ser conferidos a matrícula atualizada, as certidões do vendedor e a minuta do contrato. É neles que aparecem pendências que o anúncio não mostra.' / CTA 'O que conferir antes está no perfil'",
    },
  ...
  },
  {
    ...
    exemplos: {
      padrao:
        "CHAMADA 'NÃO É O GRÃO. É A ÁGUA.' / LEGENDA 'Café é 98% água. A gente filtra e ajusta a temperatura pra 92 graus - acima disso queima e amarga. O grão bom só aparece se a água deixar.' / CTA 'Vem sentir o que a água faz'",
      [PUBLICOS.SAUDE]:
        "CHAMADA 'POR QUE A PRESSÃO SOBE MAIS DE MANHÃ' / LEGENDA 'O corpo libera cortisol nas primeiras horas do dia, e isso eleva naturalmente a pressão arterial. Por isso a medição matinal costuma ser solicitada no acompanhamento.' / CTA 'A sua medição a gente vê na consulta'",
      [PUBLICOS.ADVOCACIA]:
        "CHAMADA 'POR QUE CONTRATO PEDE DUAS TESTEMUNHAS' / LEGENDA 'Um contrato particular assinado por duas testemunhas passa a ser título executivo extrajudicial. Na prática, isso muda o caminho da cobrança quando o combinado não é cumprido.' / CTA 'O que isso muda na cobrança: no perfil'",
    },
  ...
  },
  {
    ...
    exemplos: {
      ...
      [PUBLICOS.SAUDE]:
        "CHAMADA 'NO CALOR A SEDE CHEGA ATRASADA' / LEGENDA 'A sensação de sede aparece depois que o corpo já perdeu líquido, e no verão essa diferença aumenta. Beber em intervalos regulares funciona melhor do que esperar sentir sede.' / CTA 'Quanto beber no seu caso: na consulta'",
      [PUBLICOS.ADVOCACIA]:
        "CHAMADA 'COMEÇO DE ANO É ÉPOCA DE RESCISÃO' / LEGENDA 'Depois das festas o volume de desligamentos sobe. Vale guardar o termo de rescisão, os comprovantes de pagamento e o extrato do FGTS: são eles que sustentam qualquer discussão posterior.' / CTA 'A lista do que guardar está no perfil'",
    },
...
function blocoDoPublico(publico) {
  if (publico === PUBLICOS.ADVOCACIA) {
    return [
      ...
      "O CTA deste público FECHA O LAÇO igual (R7), só que sem captação e sem promessa: aponta ONDE a informação continua. CHAMADA '3 documentos que você precisa guardar' → CTA 'O quarto está no perfil.' Continua informativo e continua fechando o laço. Fórmula neutra ('Mais conteúdo informativo no perfil') só quando não houver nada do post para continuar.",
    ].join("\n");
  }
  ...
  if (publico === PUBLICOS.SAUDE) {
    return [
      ...
      "O CTA deste público FECHA O LAÇO igual (R7), só que sem promessa de resultado: liga o ASSUNTO do post à consulta ou à avaliação. CHAMADA '3 sinais de que o sono não está restaurador' → CTA 'Traga esses sinais na avaliação.' Fórmula neutra ('Agende uma avaliação') só quando não houver nada do post para continuar.",
    ].join("\n");
  }
...
function trioParaTexto(publico) {
  if (publico === PUBLICOS.ADVOCACIA) {
    return [
      "CERTO: CHAMADA '3 DOCUMENTOS QUE VOCÊ PRECISA GUARDAR' / LEGENDA '1) Contrato de trabalho assinado. 2) Comprovantes de pagamento. 3) Registros de jornada. Em uma discussão trabalhista, a ausência desses documentos costuma dificultar a comprovação dos fatos.' / CTA 'O quarto está no perfil'",
  ...
  if (publico === PUBLICOS.SAUDE) {
    return [
      "CERTO: CHAMADA '3 SINAIS DE QUE O SONO NÃO ESTÁ RESTAURADOR' / LEGENDA '1) Acordar cansado mesmo depois de 8 horas. 2) Sonolência no meio da tarde. 3) Dor de cabeça ao levantar. Nenhum dos três é normal por si só e todos merecem investigação.' / CTA 'Traga esses sinais na avaliação'",
  ...
  return [
    "CERTO: CHAMADA '3 ERROS QUE ESTRAGAM SEU CHURRASCO' / LEGENDA '1) Carne gelada direto na grelha. 2) Furar com garfo. 3) Sal só no final. Os três fazem a carne perder água - e água é sabor.' / CTA 'Passa aqui que a carne já sai temperada'",
...
export function blocoCopyParaSystem(publico) {
  ...
  return [
    ...
    "Esta parte governa APENAS legenda, texto_imagem, cta e familia. A direção de arte (historia_visual, descricao_fundo, resumo_cena, diretrizes A a E) segue depois e não muda nada aqui.",
    "",
    ...
    "- CTA (rodapé da arte): FECHA O LAÇO que a chamada abriu",
    ...
    "R7 — O CTA FECHA O LAÇO QUE A CHAMADA ABRIU. Ele não responde ao negócio em geral, responde À PROMESSA que a chamada acabou de fazer. O campo CTA DEVE de cada família (mais abaixo) diz o TIPO de CTA; as três formas abaixo são COMO fechar. Escolha a que combina com a família:",
    "  1. OFERECER O QUE FALTOU — a chamada entregou parte, o CTA oferece o resto. CHAMADA '3 coisas que você nunca mais precisa fazer' → CTA 'Tem uma quarta. Te conto no WhatsApp.' Só use esta forma se o extra EXISTIR de verdade nas respostas do cadastro; prometer um quarto item que você não tem é inventar (R5) — nesse caso use a forma 2 ou a 3.",
    "  2. APLICAR AO CASO DA PESSOA — a chamada falou em geral, o CTA traz para o caso dela. CHAMADA '3 sinais de que seu freio está no limite' → CTA 'Traz o seu que a gente olha na hora.'",
    "  3. CONTINUAR A FRASE — o CTA soa como a próxima linha da chamada. CHAMADA 'Isso aqui é caro?' → CTA 'Faz a conta com a gente no WhatsApp.'",
    "TESTE OBRIGATÓRIO DO CTA: troque mentalmente esse CTA para outro post do mesmo cliente. Se ele continuar servindo, é genérico — refaça. Um bom CTA só funciona NAQUELE post.",
    "NO CTA, NUNCA: repetir o que a legenda já disse; começar sempre com o mesmo verbo (não abra todo post com 'Chama'); usar convite genérico do tipo 'veja tudo que fazemos', 'conheça nossos serviços', 'saiba mais'.",
    "O CTA é curto (até 45 caracteres) porque é aplicado numa faixa pequena no rodapé da arte.",
    "",
    ...
    "- O CTA FECHA O LAÇO da chamada por uma das três formas da R7, e passa no teste da troca (não serviria em outro post deste cliente)?",
    "- O tipo de CTA bate com o CTA DEVE da família escolhida?",
